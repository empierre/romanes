...
$(document).ready(function(){
		if ($('carousel-example-generic').height() != null){
			$('.carousel .item').height( $(window).height() );
		}
		$('.info-projeto.info-fechada.related2').height($(window).height());
	window.onload = function() {
		...
		$('div#wowslider-container1').height($(window).height());
			//
		var h1 = $('a.homeProjetos')[0].clientHeight;
		...
		$('.detalhes').click(function () {
			$(".info-projeto.info-fechada.related2").slideToggle("medium");
			$("body").toggleClass("opene_info");
		});
		/*$('.closed').click(function () {
			$(".info-projeto.info-fechada.related2").slideDown("medium");
			$("body").addClass("opene_info");
		});*/
		var scrolled = 0;
